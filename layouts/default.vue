...
<template>
  <section class="flex bg-gray-100 min-h-screen">
    ...
    <!-- side bar -->
    <aside class="hidden sm:flex sm:flex-col w-[15%]">

    <a href="#" class="inline-flex items-center justify-center h-20 w-full bg-purple-600 hover:bg-purple-500 focus:bg-purple-500">
